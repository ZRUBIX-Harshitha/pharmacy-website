...
export default function HeroSection() {
    ...
    return (
        <div className="pt-10 pb-16 px-6 lg:px-10 max-w-[1600px] mx-auto font-sans">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                ...
                <div className="flex items-center gap-3 cursor-pointer text-gray-700 mr-79 mt-7 hover:text-gray-900 transition-colors">
                    ...
                    <span className="text-[#10847e] font-bold text-[21px] flex items-center gap-1 cursor-pointer hover:underline">
                        UPLOAD NOW
            ...
            <div className="relative max-w-4xl mx-auto mb-14 shadow-[0_2px_15px_rgba(0,0,0,0.06)] rounded-full">
                ...
                <input
                    ...
                    className="w-full h-[60px] pl-14 pr-36 rounded-full border border-gray-100 focus:outline-none focus:border-[#10847e] focus:ring-1 focus:ring-[#10847e] text-[16px] placeholder:text-gray-400 font-normal transition-all"
                />
                <div className="absolute inset-y-1.5 right-1.5">
                    <button className="bg-[#10847e] hover:bg-[#0c6b66] text-white px-10 h-[48px] rounded-full font-bold text-[15px] transition-colors shadow-sm">
                        Search
                    </button>
                </div>
            </div>
            ...
            <div className="relative group/carousel">
                ...
                >
                    {categories.map((item, index) => (
                        <Link key={index} href={item.link} className="flex flex-col items-center min-w-[130px] lg:min-w-[145px] group cursor-pointer p-3 rounded-xl border border-transparent hover:border-gray-200 hover:bg-white hover:shadow-lg transition-all duration-300">
