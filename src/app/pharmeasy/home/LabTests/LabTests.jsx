...
const labTests = [
    {
        ...
        bgColor: "bg-gradient-to-br from-[#e4fdf5] to-[#cbfef3]", // Greenish
                ...
                <div className="mt-12 flex flex-col lg:flex-row bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm">
                    ...
                    <div className="w-full lg:w-1/3 bg-[#ecf4ff] p-6 lg:p-8 flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <button className="bg-[#10847e] hover:bg-[#0c6b66] text-white px-6 py-2.5 rounded-md font-bold text-[15px] flex items-center gap-2 w-fit transition-colors">
                        ...
                        <div className="flex flex-col md:flex-row gap-8 lg:gap-16">
                            ...
                            <div className="flex flex-col gap-8 flex-1">
                                ...
                                <div className="flex gap-4">
                                    <span className="w-8 h-8 rounded-lg bg-[#ecf3ff] text-[#10847e] font-bold flex items-center justify-center flex-shrink-0 text-[14px]">1</span>
                                    <div className="text-[14px] text-gray-700">Upload a photo of your prescription</div>
                                </div>
                                {/* Step 2 */}
                                <div className="flex gap-4">
                                    <span className="w-8 h-8 rounded-lg bg-[#ecf3ff] text-[#10847e] font-bold flex items-center justify-center flex-shrink-0 text-[14px]">2</span>
                            ...
                            <div className="flex flex-col gap-8 flex-1">
                                {/* Step 3 */}
                                <div className="flex gap-4">
                                    <span className="w-8 h-8 rounded-lg bg-[#ecf3ff] text-[#10847e] font-bold flex items-center justify-center flex-shrink-0 text-[14px]">3</span>
                                    <div className="text-[14px] text-gray-700">We will call you to confirm the medicines</div>
                                </div>
                                {/* Step 4 */}
                                <div className="flex gap-4">
                                    <span className="w-8 h-8 rounded-lg bg-[#ecf3ff] text-[#10847e] font-bold flex items-center justify-center flex-shrink-0 text-[14px]">4</span>
