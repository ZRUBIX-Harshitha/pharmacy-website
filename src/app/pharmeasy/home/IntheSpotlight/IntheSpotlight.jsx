...
export default function IntheSpotlights() {
    ...
    return (
        <div className="w-full relative z-0" style={{ backgroundImage: "url('https://assets.pharmeasy.in/apothecary/images/spotlightBig.svg')", backgroundRepeat: 'no-repeat', backgroundPosition: 'right top', backgroundSize: 'contain' }}>
