...
export default function TrendingNearYou() {
    ...
    return (
        <div className="py-8 px-6 lg:px-10 max-w-[1600px] mx-auto font-sans">
            ...
            {/* Plus Member Banner */}
            <div className="w-full mt-10 h-auto md:h-[200px] bg-gradient-to-r from-[#7a59a3] via-[#8563ad] to-[#806cae] rounded-xl flex flex-col md:flex-row items-center justify-between px-6 lg:px-12 relative overflow-hidden shadow-sm">
