...
const checkups = [
    { image: "https://cdn01.pharmeasy.in/dam/banner/bannerImages/5d49494d55ac35029449babd4000c9fa.jpg?dim=384x384&q=75" }, // Using filler images as I didn't read specific file
];

export default function MobileCheckupsforWomen() {
    return (
        <div className="w-full bg-white py-6 font-sans border-b border-gray-100">
            <div className="px-4 mb-4">
                <h2 className="text-[#30363c] text-lg font-bold leading-tight">Checkups for Women</h2>
            </div>
