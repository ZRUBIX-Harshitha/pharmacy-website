...
const banners = [
    "https://cdn01.pharmeasy.in/dam/banner/banner/93dd2210f9c-CremaffinNat.jpg?dim=1440x0",
    "https://cdn01.pharmeasy.in/dam/banner/banner/cad28dd405c-SebamedAntiNativebanner.jpg?dim=1440x0",
    "https://cdn01.pharmeasy.in/dam/banner/banner/9e526e0c5d7-EnterogerminaNattoconsider.jpg?dim=1440x0",
    "https://cdn01.pharmeasy.in/dam/banner/banner/702ee002d57-TetmosolNat.jpg?dim=1440x0",
    "https://cdn01.pharmeasy.in/dam/banner/banner/702ee002d57-TetmosolNat.jpg?dim=1440x0",
    "https://cdn01.pharmeasy.in/dam/banner/banner/87e25be1fcd-SkoreNative.jpg?dim=1440x0",
    "https://cdn01.pharmeasy.in/dam/banner/banner/c7ec7986b34-HimalayaShilajitNat.jpg?dim=1440x0",
    "https://cdn01.pharmeasy.in/dam/banner/banner/cad28dd405c-SebamedAntiNativebanner.jpg?dim=1440x0",
    "https://cdn01.pharmeasy.in/dam/banner/banner/9e526e0c5d7-EnterogerminaNattoconsider.jpg?dim=1440x0",
];

export default function MobileIntheSpotlight() {
    ...
    return (
        <div className="py-6 px-4 font-sans border-b border-gray-100 bg-[#f8fdfd] relative overflow-hidden">
            {/* Background Decoration (optional simplified version) */}
            <div className="absolute top-0 right-0 w-24 h-24 bg-[#a7358d]/5 rounded-full blur-3xl z-0"></div>

            <div className="z-10 relative">
                <h2 className="text-lg font-bold text-gray-800 mb-4 leading-tight">In the Spotlight</h2>
                    ...
                    {newLaunches.map((item, index) => {
                        ...
                        return (
                            <div key={index} className="flex-shrink-0 w-[160px] flex flex-col group relative">
                                {/* Card Content */}
                                <Link href={item.link} className="w-full h-[160px] border border-gray-100 rounded-xl flex items-center justify-center p-3 bg-white mb-2 relative shadow-sm">
                                    <Image
                                        src={item.image}
                                        alt={item.title}
                                        width={120}
                ...
                {/* Banners Carousel */}
                <div className="flex overflow-x-auto gap-4 pb-2 scrollbar-hide -mx-4 px-4 no-scrollbar">
                    {banners.map((url, index) => (
                        <div key={index} className="flex-shrink-0 w-[85%] h-[140px] relative rounded-xl overflow-hidden shadow-sm">
                            <Image
                                src={url}
                                alt={`Banner ${index + 1}`}
                                fill
