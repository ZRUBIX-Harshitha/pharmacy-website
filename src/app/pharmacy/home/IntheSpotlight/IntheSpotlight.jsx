...
export default function IntheSpotlights() {
    ...
    const scrollBanners = (direction) => {
        if (bannerScrollRef.current) {
            ...
            const scrollAmount = 700 + 24; // Width of banner + gap
            if (direction === 'left') {
                current.scrollBy({ left: -scrollAmount, behavior: 'smooth' });
            } else {
                current.scrollBy({ left: scrollAmount, behavior: 'smooth' });
    ...
    return (
        <div className="w-full relative z-0 mt-10" style={{ backgroundImage: "url('https://assets.pharmeasy.in/apothecary/images/spotlightBig.svg')", backgroundRepeat: 'no-repeat', backgroundPosition: 'right top', backgroundSize: 'contain' }}>
            <div className="py-8 px-6 lg:px-10 max-w-[1600px] mx-auto font-sans">
                <h2 className="text-[30px] font-bold text-gray-800 leading-tight mb-1">In the Spotlight</h2>


                <div className="relative group/carousel mt-7">
                    <div
                ...
                {/* Bottom Banners Carousel */}
                <div className="relative group/banners w-full mt-15">
                    <div
                        ref={bannerScrollRef}
                    ...
                    >
                        {banners.map((url, index) => (
                            <div key={index} className="flex-shrink-0 min-w-[400px] h-[200px] relative rounded-2xl overflow-hidden cursor-pointer shadow-sm hover:shadow-md transition-shadow">
                                <Image
                                    src={url}
                                    alt={`Banner ${index + 1}`}
                                    fill
