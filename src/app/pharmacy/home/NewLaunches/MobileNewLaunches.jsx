...
export default function MobileNewLaunches() {
    ...
    return (
        <div className="py-6 px-4 font-sans border-b border-gray-100 bg-white">
            <h2 className="text-lg font-bold text-gray-800 mb-1 leading-tight">New Launches</h2>
            <p className="text-gray-500 text-sm mb-4">New wellness range just for you!</p>
