...
export default function MobileTrendingNearYou() {
    ...
    return (
        <div className="py-6 px-4 font-sans border-b border-gray-100 bg-white">
            <h2 className="text-lg font-bold text-gray-800 mb-1 leading-tight">Trending Near You</h2>
            <p className="text-gray-500 text-sm mb-4">Popular in your city</p>
            ...
            {/* Plus Banner */}
            <div className="w-full mt-6 bg-gradient-to-r from-[#7a59a3] via-[#8563ad] to-[#806cae] rounded-xl p-5 flex flex-col relative overflow-hidden shadow-sm">
                <div className="z-10 mb-4">
                    <div className="flex items-center gap-2 mb-1">
                        <span className="text-white text-lg font-bold">Become a</span>
                        <div className="w-6 h-6 flex items-center justify-center bg-[#ffcf40] rounded-md rotate-12 mx-1 shadow-sm">
                            <span className="text-white text-lg font-bold -rotate-12">+</span>
                        </div>
                        <span className="text-[#ffcf40] text-xl font-bold">Plus</span>
                        <span className="text-white text-lg font-bold">member</span>
                    </div>
                    <p className="text-white/90 text-xs font-medium mb-3">And enjoy extra bachat on every order</p>
                    <div className="w-full h-[1px] bg-white/20"></div>
                </div>

                <p className="text-white text-xs font-medium leading-relaxed mb-4 z-10 w-[65%]">
                    Save 5% on medicines, 50% on 1st lab test & get FREE delivery.
                </p>
                <button className="bg-[#f0a92e] text-white font-bold py-2.5 px-6 rounded-lg text-xs shadow-md w-fit z-10 active:scale-95 transition-transform">
                    Explore Now
                </button>
